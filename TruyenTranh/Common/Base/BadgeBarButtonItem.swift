...
//  TruyenTranh
//
//  Created by Trung Hoang Van on 6/24/20.
...
extension UIBarButtonItem {
    ...
    func addBadge(number: Int, withOffset offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.red, andFilled filled: Bool = false) {
